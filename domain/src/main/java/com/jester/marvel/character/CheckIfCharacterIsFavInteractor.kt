 ...
 */
class CheckIfCharacterIsFavInteractor @Inject constructor(postExecutionThread: PostExecutionThread,
                                                          val repository: CharacterRepository)
    : Interactor<Character, CheckIfCharacterIsFavInteractor.Parameters>(postExecutionThread) {

    override fun run(params: Parameters): Result<Character, Exception> {
        return repository.checkIfCharacterIsFav(params.id)
    }
